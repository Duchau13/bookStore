      ...
      <div className={classes["header-logo"]}>
        <div className={classes["container-logo"]}>
          <div className={classes.logo}>
            <img src="https://bizweb.dktcdn.net/100/282/917/themes/637314/assets/logo.png?1693178105197"  alt="logo" style={{width: "100px", height: "100px"}} />
          </div>
        </div>
      </div>
      <Container>
        <Row>
          ...
          <Col lg={3} md={6} style={{ padding: "12px" }}>
            <div className={classes["content-item"]}>
              <h2 className={classes["header-content-item"]}>Mua Sách</h2>
